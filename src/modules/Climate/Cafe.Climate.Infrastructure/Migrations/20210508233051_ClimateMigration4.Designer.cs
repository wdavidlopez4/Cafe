...
namespace Cafe.Climate.Infrastructure.Migrations
{
    ...
    [Migration("20210508233051_ClimateMigration4")]
    partial class ClimateMigration4
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cafe.Climate.Domain.Entities.ClimateAccumulated", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<double>("AccumulatedAltitude")
                        .HasColumnType("float");

                    b.Property<double>("AccumulatedHumedity")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Cafe.Climate.Domain.Entities.TemperatureDegreesDays", b =>
                {
                    b.HasBaseType("Cafe.Climate.Domain.Entities.ClimaticFactor");

                    b.Property<double>("DegreesDays")
                        .HasColumnType("float");

                    b.Property<DateTime>("Time")
                        .HasColumnType("datetime2");

                    b.HasDiscriminator().HasValue("TemperatureDegreesDays");
                });
            ...
            modelBuilder.Entity("Cafe.Climate.Domain.Entities.TemperatureInceptThreshold", b =>
                {
                    ...
                    b.Property<int>("OptimalStateDevelopmentThreshold")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cafe.Climate.Domain.Entities.ClimateAccumulated", b =>
                {
                    b.HasOne("Cafe.Climate.Domain.Entities.Monitoring", "Monitoring")
                        .WithOne("ClimateAccumulated")
                        .HasForeignKey("Cafe.Climate.Domain.Entities.ClimateAccumulated", "MonitoringId");
                });
