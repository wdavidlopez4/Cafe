...
namespace Cafe.Climate.Domain.Factories
{
    ...
    {
        public EntityBase CreateArduino(double temperature, double humididy, double altitude, Monitoring monitoring = null)
        {
            return new Arduino(temperature, humididy, altitude, monitoring);
        }
